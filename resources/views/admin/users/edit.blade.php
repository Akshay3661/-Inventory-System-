...
@section('content')
    <div id="kt_app_content" class=" flex-column-fluid mt-10 mb-10">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form action="{{route('admin.users.update',$user->id)}}" method="post" enctype="multipart/form-data" id="User_manage_Edit">
                @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="number" name="mono" id="mono" class="form-control mb-2 @error('mono') is-invalid @enderror" placeholder="Mobile No" value="{{$user->mono}}">
                            @error('mono')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="emp_id" id="emp_id" class="form-control mb-2 @error('emp_id') is-invalid @enderror" placeholder="Employee Id" value="{{$user->emp_id}}">
                            @error('emp_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            {{-- <img src=" {{ asset('user_image/'.$user->image) }}" style="width:80px;height:80px" class="mb-5">
                            <input type="file" name="image" id="image" class="form-control mb-2" placeholder="Employee Id" value="{{ old('image', $user->image ?? null) }}"> --}}
                                ...
                                <div class="card-body text-center pt-0">
                                    <style>
                                        .image-input-placeholder {
                                            background-image: url('{{ asset('user_image/'.$user->image) }}');
                                        }
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{route('admin.users.list')}}" id="kt_ecommerce_add_product_cancel"
