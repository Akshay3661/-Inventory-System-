...
@section('content')
    <div id="kt_app_content" class=" flex-column-fluid mt-10 mb-10">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form action="{{route('admin.category.update',['id'=> $category->id])}}" method="post" enctype="multipart/form-data" id="Edit_Category">
                @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <textarea name="description" id="description" class="form-control mb-2  @error('description') is-invalid @enderror" rows="5" placeholder="Description">{{$category->description}}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="card-body text-center pt-0">
                                    <style>
                                        .image-input-placeholder {
                                            background-image: url('{{ asset('category_image/'.$category->image) }}');
                                        }
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                ...
                                <div class="d-flex fv-row mb-5">
                                    <div class="form-check form-check-custom form-check-solid me-10">
                                        <input class="form-check-input me-0  @error('status') is-invalid @enderror" name="status" type="radio" value="Active" id="status" {{$category->status == 'Active' ? 'checked':''}} />
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input me-0  @error('status') is-invalid @enderror" name="status" type="radio" value="Inactive" id="status" {{$category->status == 'Inactive' ? 'checked':''}} />
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{route('admin.category.list')}}" id="kt_ecommerce_add_product_cancel"
