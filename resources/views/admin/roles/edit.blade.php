        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        {{-- <div class="mb-10 fv-row">
                          @foreach($permission as $value)
                            <div class="form-check mb-4">
                                <input class="form-check-input" type="checkbox" id="permission" name="permission[]" value="{{ $value->id }}"  @if(in_array($value->id,$rolePermissions)) checked @endif>
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <div class="form-check ">
                                          ...
                                          data-class="select-{{ $permission_data->group_name }}-permission" type="checkbox" id="permission{{ $permission_data->id }}" name="permission[]" value="{{ $permission_data->id }}" @if(in_array($permission_data->id,$rolePermissions)) checked @endif>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{route('admin.roles.list')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
