                            ...
                            <div class="card-body pt-0 mt-10">
                                ...
                                <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                    <div id="kt_docs_repeater_advanced">
                                            ...
                                            <div data-repeater-list="assign_product" class="d-flex flex-column gap-3">
                                                <div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5">
                                                    ...
                                                    <div class="w-100 w-md-150px">
                                                        ...
                                                        <select class="form-select  @error('product_id') is-invalid @enderror" id="product" name="product" data-kt-repeater="select2" data-placeholder="Select an Product">
                                                    ...
                                                    <label class="required form-label">Assign date</label>
                                                        <input type="date" name="assigndate" id="assigndate" class="form-control mb-2  @error('assigndate') is-invalid @enderror" data-kt-repeater="datepicker">
                                                        @error('assigndate')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="w-100 w-md-150px">
                                                        ...
                                                        <input type="number" name="quantity" id="quantity" class="form-control mb-2  @error('quantity') is-invalid @enderror" placeholder="Quantity">
                                                        @error('quantity')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="w-100 w-md-150px">
                                                        ...
                                                        <input type="text" name="condition" id="condition" class="form-control mb-2  @error('condition') is-invalid @enderror" placeholder="Condition" >
                                                        @error('condition')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                        ...
                                        <div class="form-group">
                                            <div data-repeater-list="assign_product" class="d-flex flex-column gap-3">
                                                @foreach ($employee->products as $pivot_data)
                                                <div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5">
                                                    <!--begin::Select2-->
                                                    <div class="w-100 w-md-150px">
                                                        <label class="required form-label">Product</label>
                                                        ...
                                                        <select class="form-select  @error('product_id') is-invalid @enderror" name="product" data-kt-repeater="select2" data-placeholder="Select an Product">
                                                            <option value=' '>Select Product</option>
                                                            @foreach ($product as $products )
                                                                <option value="{{$products->id}}" {{$pivot_data->pivot->product_id == $products->id ? 'selected':''}}>{{$products->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="w-100 w-md-150px">
                                                    <label class="required form-label">Assign date</label>
                                                        <input type="date" name="assigndate" id="assigndate" class="form-control mb-2  @error('assigndate') is-invalid @enderror" data-kt-repeater="datepicker"  value="{{$pivot_data->pivot->assigndate}}" >
                                                        @error('assigndate')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="w-100 w-md-150px">
                                                        <label class="required form-label">Quantity</label>
                                                        <input type="number" name="quantity" id="quantity" class="form-control mb-2  @error('quantity') is-invalid @enderror" placeholder="Quantity" value="{{$pivot_data->pivot->quantity}}">
                                                        @error('quantity')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="w-100 w-md-150px">
                                                        <label class="required form-label">Condition</label>
                                                        <input type="text" name="condition" id="condition" class="form-control mb-2  @error('condition') is-invalid @enderror" placeholder="Condition" value="{{$pivot_data->pivot->condition}}">
                                                        @error('condition')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
